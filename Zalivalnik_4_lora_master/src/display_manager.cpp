...
#include "Lora_master.h" // Potrebujemo za dostop do 'kanal' strukture v PrikaziStanjeRelejev
...
void init_display()
{
  u8g2.begin();
  u8g2.clearBuffer();
  u8g2.setFont(u8g2_font_ncenB08_tr); // Privzeti font
}
...
// // Funkcija za izris glavnega zaslona (prej v main.cpp)
// void drawMain()
// {
//   u8g2.clearBuffer();
...
// Funkcija za prikaz stanja relejev (prej v main.cpp)
// void PrikaziStanjeRelejev()
// {
//   u8g2.clearBuffer();
//   u8g2.setFont(u8g2_font_6x10_tf);
//   u8g2.setCursor(0, 10);
//   u8g2.print("Stanje relejev:");

//   for (int i = 0; i < 8; i++)
//   {
//     String releLine = "K" + String(i + 1) + ": " + (kanal[i].state ? "ON" : "OFF");
